...
export async function seedDatabase() {
  ...
  const empData = await db.insert(employees).values([
    ...
    { nip: "PDAM-009", fullName: "Baiq Nurul Hidayah", gender: "Perempuan", birthPlace: "Selong", birthDate: "1995-04-10", address: "Jl. TGH Zainuddin No. 12, Selong", phone: "081234567898", email: "nurul.hidayah@pdam-rinjani.id", religion: "Islam", education: "S1 Akuntansi", departmentId: deptData[1].id, positionId: posData[4].id, status: "aktif", employeeType: "kontrak", grade: "II/a", joinDate: "2022-01-15", bpjs: "0001234567898", bankAccount: "1234567898", bankName: "Bank NTB", maritalStatus: "Lajang", lastPromotionDate: null, lastSalaryIncreaseDate: "2024-01-15", contractEndDate: "2026-12-31" },
